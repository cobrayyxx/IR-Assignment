...
class LetorBoost(Document, Queries):
    ...
    def __init__(self, path_doc, path_queries, path_qrels):
        ...
        self.model = LsiModel(corpus=self.bow_corpus, num_topics = self.NUM_LATENT_TOPICS) # 200 latent topics
    ...
    #src: https://medium.com/predictly-on-tech/learning-to-rank-using-xgboost-83de0166229d
    def train_letor(self):
        ...
        ranker.fit(X,Y,group=self.group_qid_count)
...
if __name__=="__main__":
    ...
    X_unseen = []
    model = LetorBoost("nfcorpus/train.docs", "nfcorpus/train.vid-desc.queries", "nfcorpus/train.3-2-1.qrel")
